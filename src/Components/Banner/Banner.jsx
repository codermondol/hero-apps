        ...
        <div className='text-center w-6/12 mx-auto space-y-10 justify-center'>
            <div className='space-y-5'>
                ...
                <div className='flex gap-10 justify-center'>
                    <button className='flex items-center gap-4 text-xl font-bold btn border-gray-200 py-7 rounded hover:bg-gradient-to-br hover:from-[#632EE3] hover:to-[#9F62F2]
  hover:text-white'> <img src={googlePlayStoreIcon} alt="" /> <span>Google Play</span></button>
                    <button className='flex items-center gap-4 text-xl font-bold btn border-gray-200 py-7 rounded hover:bg-gradient-to-br hover:from-[#632EE3] hover:to-[#9F62F2]
  hover:text-white'> <img src={appleStoreIcon} alt="" /> <span>Apple Store</span></button>
                </div>
            </div>
